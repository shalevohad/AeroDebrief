...
namespace AeroDebrief.DevTools
{
    ...
    /// </summary>
    public class ExportFrequencyTool
    {
        ...
        public static async Task<int> Main(string[] args)
        {
            try
            {
                ...
                Console.WriteLine("???  Applying frequency filter...");
        ...
        private static void ShowUsage()
        {
            ...
            Console.WriteLine("  ExportFrequencyTool <recording.raw> <frequency_mhz> [output.wav]");
            Console.WriteLine();
            ...
            Console.WriteLine("  ExportFrequencyTool recording.raw 303.1");
            Console.WriteLine("  ExportFrequencyTool recording.raw 251.0 output.wav");
            Console.WriteLine();
